...
/**
 * Base dagger qualifier for android support fragment children.
 *
 * <p>A simple {@code javax.inject.Qualifier}, 'intended' to qualify an {@code android.support.v4.app.Fragment},
 * that is the child of a {@link FragmentQualified} {@code android.support.v4.app.Fragment}.</p>
 *
